    ...
    return RefreshConfiguration(
      ...
      child: MaterialApp(
        ...
        onGenerateRoute: (settings) {
          ...
          if (settings.name == WorshipGuideItemScreen.routeName) {
            // Cast the arguments to the correct type: ScreenArguments.
            final ScreenArguements args = settings.arguments;
            return MaterialPageRoute(
              builder: (context) {
                return WorshipGuideItemScreen(
                  worshipGuideItem: args.items,
                );
              },
            );
          }
          ...
          if (settings.name == Imageviewer.routeName) {
            // Cast the arguments to the correct type: ScreenArguments.
            final ScreenArguements args = settings.arguments;
            return MaterialPageRoute(
              builder: (context) {
                return Imageviewer(photos: args.items);
              },
            );
          }

          if (settings.name == SermonsScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
          ...
          if (settings.name == ConnectCardScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
          ...
          if (settings.name == GiveTestimonyScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
                return GiveTestimonyScreen();
              },
            );
          }

          if (settings.name == EventsCalenderScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
                return EventsCalenderScreen();
              },
            );
          }

          if (settings.name == PrayerRequestScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
          ...
          if (settings.name == LifeGroupScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
                return LifeGroupScreen();
              },
            );
          }
          ...
          if (settings.name == WorshipGuideScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
                return WorshipGuideScreen();
              },
            );
          }

          if (settings.name == BulletinScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
          ...
          if (settings.name == LifeGroupItemScreen.routeName) {
            // Cast the arguments to the correct type: ScreenArguments.
            final ScreenArguements args = settings.arguments;
            return MaterialPageRoute(
              builder: (context) {
                return LifeGroupItemScreen(
                  groups: args.items,
                );
              },
            );
          ...
          if (settings.name == MinistryItemScreen.routeName) {
            // Cast the arguments to the correct type: ScreenArguments.
            final ScreenArguements args = settings.arguments;
            return MaterialPageRoute(
              builder: (context) {
                return MinistryItemScreen(
                  ministries: args.items,
                );
              },
            );
          }
