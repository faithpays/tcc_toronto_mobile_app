      ...
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(height: 20),
            Visibility(
              visible: widget.events.location != "",
              child: ListTile(
                ...
                subtitle: Align(
                  alignment: Alignment.centerLeft,
                  child: Text((widget.events.location),
                      textAlign: TextAlign.justify,
                      style:
                          TextStyles.subhead(context).copyWith(fontSize: 18)),
                ),
              ),
            ),
            Visibility(visible: widget.events.location != "", child: Divider()),
            ListTile(
              contentPadding: EdgeInsets.all(0),
              title: Text("Date",
                  style: TextStyles.headline(context)
              ...
              subtitle: Align(
                ...
                child: Text(
                    ...
                    textAlign: TextAlign.justify,
                    style: TextStyles.subhead(context).copyWith(fontSize: 18)),
              ),
            ),
            Divider(),
            ListTile(
            ...
            Visibility(
              ...
              child: ListTile(
                ...
                subtitle: Align(
                  alignment: Alignment.centerLeft,
                  child: Text((widget.events.enquiry),
                      textAlign: TextAlign.justify,
                      style:
                          TextStyles.subhead(context).copyWith(fontSize: 18)),
                ),
            ...
            Visibility(visible: widget.events.enquiry != "", child: Divider()),
            Container(height: 20),
          ],
        ),
      );
